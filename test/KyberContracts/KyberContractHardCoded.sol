...
contract KyberNetworkTokenSale {
    address             public admin= 0x872c4bbBEe212D28d703F5A5c3cE77Ef019Aea8d;
    address             public kyberMultiSigWallet= 0xeC5172045153d38BEf7C372463c8DcEa54Eee64e;
    KyberNetworkCrystal public token;
    uint                public raisedWei;
    bool                public haltSale;
    uint                public cappedSaleStartTime = 1505490423;
    uint                public openSaleStartTime = 1505490423;
    uint                public openSaleEndTime = 1605490423;
    uint                public totalTokenSupply = 226000000000000000000000000;
    ...
    function KyberNetworkTokenSale( ) {
        token = new KyberNetworkCrystal( totalTokenSupply,
                                         cappedSaleStartTime,
                                         openSaleEndTime + 7 days,
                                         admin );

        addCap(0xeC5172045153d38BEf7C372463c8DcEa54Eee64e);
    }



    // added
    function addCap(address _user ) {
        addressCap[_user] = 999999999999999999999;
    }
    ...
    function contributorCap( address contributor ) constant returns(uint) {
        // copied from KyberContributorWhitelist
        uint cap = addressCap[contributor];
